...
if (isset($_POST['save'])) {
    ...
    $sql = "UPDATE users SET firstname = '$fname', lastname='$lname' WHERE userid='$userid'";
...
if (isset($_POST['but_upload'])) {
    ...
    if (in_array($imageFileType, $extensions_arr) && $_FILES['file']['size'] < 5000000) {
    
        // Update query with correct column name 'userid'
        $query = "UPDATE users SET profile_path = '$name' WHERE userid = '$userid'";
        
        // Execute the query
        if (mysqli_query($con, $query)) {
            // Upload the file if query is successful
